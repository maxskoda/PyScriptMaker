...
myActions = "Actions.SANSActions_Python"#"SANSActions_Python" #"MuonActions"

SANSActions = __import__('Actions.SANSActions_Python', globals(), locals(), ['SANSActions_Python'], 0) #__import__('MuonActions')
